...
switch (GlobalVariable.SOPv3_Instance) {
    ...
    case 'ST4':
        ...
        WebUI.click(findTestObject('SOPV3/Order Processing/Order_detail/a_Detail_tab'), FailureHandling.STOP_ON_FAILURE)

        WebUI.delay(1)

        WebUI.verifyElementPresent(findTestObject('SOPV3/CNC/Used_promotion_text_order_details'), 0)

...
switch (GlobalVariable.BranchV3_Instance) {
    ...
    case 'ST4':
        ...
        WebUI.click(findTestObject('BranchV3/Collection Orders/ECP_filter_order_button'))

        WebUI.waitForPageLoad(0)

        WebUI.delay(2)

        WebUI.selectOptionByValue(findTestObject('BranchV3/Collection Orders/Branch_filter'), '46', false)

        WebUI.click(findTestObject('BranchV3/Collection Orders/Submit_button'))

        WebUI.delay(2)

        WebUI.verifyElementPresent(findTestObject('BranchV3/Collection Orders/View_collection_order'), 0)

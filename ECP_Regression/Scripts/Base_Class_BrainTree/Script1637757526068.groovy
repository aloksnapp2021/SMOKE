...
switch (GlobalVariable.SOPv3_Instance) {
	...
	case 'LIVE':
		...
		break
	case 'ST1':
		WebUI.navigateToUrl(GlobalVariable.SOP_URL_ST1)
		...
		break
	case 'ST2':
		WebUI.navigateToUrl(GlobalVariable.SOP_URL_ST2)
	...
	case 'ST3':
		...
		break
	case 'ST4':
		WebUI.navigateToUrl(GlobalVariable.SOP_URL_ST4)
		...
		break
	case 'DR':
		WebUI.navigateToUrl(GlobalVariable.SOP_URL_DR)

		WebUI.waitForPageLoad(0)

		WebUI.delay(1)

		WebUI.sendKeys(findTestObject('SOPV3/Login/login_Username'), GlobalVariable.CMS_login_username_LIVE)

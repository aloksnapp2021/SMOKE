...
WebUI.click(findTestObject('Basket_objects/Random_object/Breadcrumb_HOME_navigate'))
...
WebUI.verifyElementPresent(findTestObject('Basket_objects/PLP_cart_minicart/cart_popup_Continue Shopping'), 5)

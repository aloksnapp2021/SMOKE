...
WebUI.sendKeys(findTestObject('Basket_objects/Random_object/input_Promo_code'), 'WRONGPROMO')

WebUI.click(findTestObject('Basket_objects/Random_object/Promo_code_submit'))

WebUI.delay(2)

WebUI.verifyElementPresent(findTestObject('Basket_objects/Random_object/Promocode_error_bar'), 5)

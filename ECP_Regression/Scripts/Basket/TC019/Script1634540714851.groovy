...
WebUI.click(findTestObject('Basket_objects/Cart_postcode_objects/button_Collection'))

WebUI.delay(2)

WebUI.verifyElementPresent(findTestObject('Basket_objects/Cart_postcode_objects/Cart_CNC_find_store_popup'), 5)

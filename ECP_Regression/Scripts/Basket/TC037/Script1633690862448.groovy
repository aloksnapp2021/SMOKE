...
WebUI.sendKeys(findTestObject('HeaderS_objects/Search_home/input_search_box'), GlobalVariable.ProductNonHWD)
...
WebUI.verifyTextPresent(GlobalVariable.ProductNo, false)

WebUI.verifyTextNotPresent(GlobalVariable.ProductNonHWD, false)

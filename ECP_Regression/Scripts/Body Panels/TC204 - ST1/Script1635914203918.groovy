...
WebUI.sendKeys(findTestObject('HeaderS_objects/Search_home/input_search_box'), GlobalVariable.BodyPanel_Product)
...
WebUI.click(findTestObject('Order_Placement_Journey/HWD_Journey/input__email'))
...
WebUI.click(findTestObject('Order_Placement_Journey/HWD_Journey/Delivery_select_HWD_ST1'))

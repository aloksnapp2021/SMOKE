...
WebUI.sendKeys(findTestObject('Order_Placement_Journey/Checkout_CC/input_Credit Card Number'), '7777777777777777')

WebUI.sendKeys(findTestObject('Order_Placement_Journey/Checkout_CC/input_ExpDate'), '78/56')

WebUI.sendKeys(findTestObject('Order_Placement_Journey/Checkout_CC/input_CVV'), '')

WebUI.verifyTextPresent('Please enter a valid card number.', false)

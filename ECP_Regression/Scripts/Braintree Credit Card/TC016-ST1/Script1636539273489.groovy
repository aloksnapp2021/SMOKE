...
WebUI.sendKeys(findTestObject('Order_Placement_Journey/Checkout_Security_popup/input_OTP'), 'gsdgsdfvf')

WebUI.click(findTestObject('Order_Placement_Journey/Checkout_Security_popup/button_submit'))

WebUI.delay(3)

WebUI.verifyElementPresent(findTestObject('Checkout_objects/Security_OTP/Invalid OTP Alert'), 0)

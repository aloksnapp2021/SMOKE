...
checkout_email = WebUI.verifyElementVisible(findTestObject('Order_Placement_Journey/HWD_Journey/input__email'), FailureHandling.OPTIONAL)

if (checkout_email == false) {
    WebUI.click(findTestObject('Order_Placement_Journey/HWD_Journey/Basket_UK delivery_after_postcode'))
...
WebUI.click(findTestObject('Checkout_objects/Security_OTP/Resend Button'))

WebUI.delay(3)

WebUI.verifyElementPresent(findTestObject('Checkout_objects/Security_OTP/OTP Resend Alert'), 0)

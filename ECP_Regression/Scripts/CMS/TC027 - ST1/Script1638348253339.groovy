...
WebUI.scrollToElement(findTestObject('CMS/Menu_Links/Top_menu_links/a_Manage SDD'), 0)

WebUI.mouseOver(findTestObject('CMS/Menu_Links/Top_menu_links/a_Manage SDD'))

WebUI.click(findTestObject('CMS/Menu_Links/Top_menu_links/a_Manage SDD Postcodes'))

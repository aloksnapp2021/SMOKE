...
WebUI.scrollToElement(findTestObject('CMS/Menu_Links/Top_menu_links/a_Manage Printers'), 0)

WebUI.mouseOver(findTestObject('CMS/Menu_Links/Top_menu_links/a_Manage Printers'))

WebUI.click(findTestObject('CMS/Menu_Links/Top_menu_links/a_DHL Printer'))

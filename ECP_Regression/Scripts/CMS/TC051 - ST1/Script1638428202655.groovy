...
WebUI.click(findTestObject('CMS/Menu_Links/Top_menu_links/a_Audit Trail Logs'))

WebUI.click(findTestObject('CMS/Menu_Links/Top_menu_links/a_SOPV3 User Activity'))

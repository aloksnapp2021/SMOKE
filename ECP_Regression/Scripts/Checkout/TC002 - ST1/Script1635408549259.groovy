...
Postcode = WebUI.verifyElementVisible(findTestObject('Order_Placement_Journey/HWD_Journey/Basket_input_postcode'), FailureHandling.OPTIONAL)
...
WebUI.verifyElementPresent(findTestObject('Order_Confirmation_objects/HWD/Product_code_text'), 0)

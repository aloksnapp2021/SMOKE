...
WebUI.click(findTestObject('Checkout_objects/Page_Checkout/Guest_Login_Register/Checkout_as_register'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('Checkout_objects/Page_Checkout/Guest_Login_Register/Checkout_as_register'), 10)

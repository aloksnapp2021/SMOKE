...
WebUI.verifyElementPresent(findTestObject('Order_Placement_Journey/HWD_Journey/input_Address_1'), 10)

WebUI.verifyElementPresent(findTestObject('Order_Placement_Journey/HWD_Journey/input_Address_2'), 10)

WebUI.verifyElementPresent(findTestObject('Order_Placement_Journey/HWD_Journey/Country Select'), 10)

WebUI.verifyElementPresent(findTestObject('Order_Placement_Journey/HWD_Journey/input_City_Town'), 10)

WebUI.verifyElementPresent(findTestObject('Order_Placement_Journey/HWD_Journey/input_address_postcode'), 10)

...
WebUI.scrollToElement(findTestObject('Checkout_objects/Page_Checkout/button_Place Order'), 0)

WebUI.click(findTestObject('Checkout_objects/Page_Checkout/button_Place Order'))

WebUI.delay(2)

WebUI.verifyElementPresent(findTestObject('Checkout_objects/Page_Checkout/Register_Email_blank_error'), 0)

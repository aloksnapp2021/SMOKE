...
WebUI.sendKeys(findTestObject('Basket_objects/Cart_postcode_objects/input_postcode'), GlobalVariable.Postcode, FailureHandling.OPTIONAL)

WebUI.click(findTestObject('Basket_objects/Cart_postcode_objects/button_Collection'), FailureHandling.OPTIONAL)
...
WebUI.verifyElementPresent(findTestObject('Checkout_objects/CNC/Collect_today_text'), 0)

...
WebUI.sendKeys(findTestObject('Order_Placement_Journey/HWD_Journey/Basket_input_postcode'), '@#!@#!@#')

WebUI.click(findTestObject('Order_Placement_Journey/HWD_Journey/Basket_UK Delivery'))

WebUI.delay(2)

WebUI.verifyElementPresent(findTestObject('Basket_objects/Cart_postcode_objects/BFPO_postcode_error'), 0)

WebUI.clearText(findTestObject('Order_Placement_Journey/HWD_Journey/Basket_input_postcode'), FailureHandling.STOP_ON_FAILURE)

WebUI.sendKeys(findTestObject('Order_Placement_Journey/HWD_Journey/Basket_input_postcode'), 'WQEQWE')

...
WebUI.scrollToElement(findTestObject('Basket_objects/Cart_postcode_objects/input_postcode_HWD_again'), 0)
...
WebUI.verifyElementPresent(findTestObject('Checkout_objects/Page_Checkout/Footer T_C_Links/Terms_Conditions'), 0, FailureHandling.OPTIONAL)

...
WebUI.sendKeys(findTestObject('Resetpass_objects/input_Password'), GlobalVariable.Login_password_LIVE)

WebUI.sendKeys(findTestObject('Resetpass_objects/input_Confirm Password'), GlobalVariable.Login_password_LIVE)
...
WebUI.verifyElementPresent(findTestObject('Resetpass_objects/reset_successverify'), 5)
*/

...
WebUI.sendKeys(findTestObject('Resetpass_objects/input_Confirm Password'), 'Tester@123123')
...
WebUI.verifyElementPresent(findTestObject('Resetpass_objects/Mismatchingpass_error'), 5)
*/

...
WebUI.click(findTestObject('Admin/Dashboard/link_Edit_UK_ST3'))
...
WebUI.verifyElementPresent(findTestObject('Admin/Site Module/Google Pay (Off)'), 0)

WebUI.verifyElementPresent(findTestObject('Admin/Site Module/Clear Cache For UK'), 0)

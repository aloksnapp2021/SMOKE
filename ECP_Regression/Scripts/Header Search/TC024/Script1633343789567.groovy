...
WebUI.mouseOver(findTestObject('HeaderS_objects/a_Tools'))

WebUI.delay(1)

WebUI.click(findTestObject('HeaderS_objects/a_tools_accessories'))

WebUI.delay(4)

WebUI.verifyTextPresent('Compression Testers', false)

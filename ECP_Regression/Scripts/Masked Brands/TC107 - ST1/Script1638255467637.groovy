...
WebUI.verifyElementPresent(findTestObject('Basket_objects/Car Parts Page/Change Vehicle Button'), 5, FailureHandling.OPTIONAL)

WebUI.sendKeys(findTestObject('HeaderS_objects/Search_home/input_search_box'), GlobalVariable.GroupProductCode2)

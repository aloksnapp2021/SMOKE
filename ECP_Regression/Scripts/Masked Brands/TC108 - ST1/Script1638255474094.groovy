...
//Verifying special buy product does not contain original brand name in Title
...
//Verifying special buy product does not contain original brand name in Title at Review Page
Exists = ProductName.contains('Castrol')
...
//Verifying special buy product does not contain original brand name in Title at Workshop Page
WebUI.verifyEqual(Exists, false)

WebUI.delay(3)

WebUI.scrollToElement(findTestObject('Order_Placement_Journey/FIFM_Journey/View_details_scroll'), 0)
...
//Verifying special buy product does not contain original brand name in Title at Checkout Page
WebUI.verifyEqual(Exists, false)

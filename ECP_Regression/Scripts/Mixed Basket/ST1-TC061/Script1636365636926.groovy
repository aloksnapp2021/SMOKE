...
PendingProduct = WebUI.getText(findTestObject('Product_Details_Objects/PDP/Product_title'))
...
WebUI.verifyTextPresent('You’re all set!', false, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Global_objects/Basket_icon'))

WebUI.click(findTestObject('Global_objects/Basket_icon_View_Basket'))
...
ProductTitle = WebUI.getText(findTestObject('Global_objects/Basket_Icon_Product_title'))

WebUI.verifyEqual(PendingProduct, ProductTitle)

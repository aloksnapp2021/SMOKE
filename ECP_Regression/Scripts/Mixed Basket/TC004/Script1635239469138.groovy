...
Promo = WebUI.getAttribute(findTestObject('Basket_objects/Random_object/input_Promo_code'), 'value')

println(Promo)

WebUI.click(findTestObject('Basket_objects/Random_object/Promo_code_Remove_button'))

WebUI.sendKeys(findTestObject('Basket_objects/Random_object/input_Promo_code'), Promo)

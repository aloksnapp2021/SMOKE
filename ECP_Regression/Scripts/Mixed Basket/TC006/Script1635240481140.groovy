...
Title = WebUI.getText(findTestObject('Product_Details_Objects/PDP/Product_title'))
...
WebUI.click(findTestObject('Basket_objects/Random_object/Cart Product Title'))

WebUI.waitForPageLoad(0)

WebUI.verifyElementPresent(findTestObject('Product_Details_Objects/PDP/Product_title'), 0)

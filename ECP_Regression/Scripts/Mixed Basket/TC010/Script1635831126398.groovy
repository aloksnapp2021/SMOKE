...
PostcodeText = WebUI.getText(findTestObject('Order_Placement_Journey/HWD_Journey/Basket_input_postcode'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyEqual(PostcodeText, "")

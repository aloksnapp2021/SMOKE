...
WebUI.verifyElementPresent(findTestObject('Order_Placement_Journey/CNC-POCI_ROCI_Journey/PLP_to_Cart/button_Collection'), 
    0)

WebUI.verifyElementPresent(findTestObject('Basket_objects/Cart_postcode_objects/button_UK Delivery'), 0)

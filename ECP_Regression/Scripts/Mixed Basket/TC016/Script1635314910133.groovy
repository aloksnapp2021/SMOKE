...
WebUI.verifyElementPresent(findTestObject('Basket_objects/Collection PopUp/Collection Popup Product Image'), 0)

WebUI.verifyElementPresent(findTestObject('Basket_objects/Collection PopUp/Collection PopUp Product Title'), 0)

WebUI.verifyElementPresent(findTestObject('Basket_objects/Collection PopUp/Collection PopUp Product Code'), 0)

WebUI.verifyTextPresent('Wembley', false)

WebUI.verifyElementPresent(findTestObject('Basket_objects/Collection PopUp/Collection PopUp View Map'), 0)

WebUI.verifyElementPresent(findTestObject('Basket_objects/Collection PopUp/Collection PopUp Miles Text'), 0)

...
WebUI.click(findTestObject('Basket_objects/Cart_postcode_objects/a_Change postcode_HWD_link'))
...
WebUI.verifyTextPresent('Checkout With International Delivery', false)

WebUI.selectOptionByIndex(findTestObject('Checkout_objects/Page_Checkout/Int_delivery/select_country'), 1)

WebUI.delay(2)

WebUI.verifyTextPresent('Sorry, One or more item(s) in your basket is not available for delivery.', false)

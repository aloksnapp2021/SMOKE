...
WebUI.verifyTextPresent('Contact details - register for faster checkout and quick access to your order information', false)

WebUI.verifyTextPresent('Delivery details', false)

WebUI.verifyTextPresent('Delivery options', false)

WebUI.verifyTextPresent('Payment methods', false)

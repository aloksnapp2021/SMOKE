...
WebUI.selectOptionByIndex(findTestObject('Order_Placement_Journey/HWD_Journey/Country Select'), 2)

WebUI.delay(2)

WebUI.verifyElementNotPresent(findTestObject('Order_Placement_Journey/HWD_Journey/Address_select'), 0)

...
WebUI.verifyElementVisible(findTestObject('Order_Placement_Journey/HWD_Journey/Total Including Delivery (Price)'))

WebUI.verifyElementVisible(findTestObject('Order_Placement_Journey/HWD_Journey/Product Price (Price)'))

WebUI.verifyElementVisible(findTestObject('Order_Placement_Journey/HWD_Journey/Subtotal (Price)'))

WebUI.verifyElementVisible(findTestObject('Order_Placement_Journey/HWD_Journey/Discount (value)'))

WebUI.verifyElementVisible(findTestObject('Order_Placement_Journey/HWD_Journey/Shipping and Handling charge (Value)'))

WebUI.verifyElementVisible(findTestObject('Order_Placement_Journey/HWD_Journey/Total (inc VAT) (Value)'))

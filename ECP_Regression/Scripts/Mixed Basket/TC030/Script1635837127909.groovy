...
Producttitle = WebUI.getText(findTestObject('Basket_objects/Random_object/Cart Product Title'))

ProductPrice = WebUI.getText(findTestObject('Basket_objects/Random_object/cart_product_price'))
...
Quantity = WebUI.getText(findTestObject('Order_Placement_Journey/HWD_Journey/Product quantity'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyEqual(Quantity, '1')

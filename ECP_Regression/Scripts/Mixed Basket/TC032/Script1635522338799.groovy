...
WebUI.verifyElementPresent(findTestObject('Checkout_objects/Page_Checkout/Page_Checkout/Checkout_as_guest'), 0)

WebUI.verifyElementPresent(findTestObject('Checkout_objects/Page_Checkout/Page_Checkout/Checkout_as_register'), 0)

WebUI.verifyElementPresent(findTestObject('Checkout_objects/Page_Checkout/Page_Checkout/Checkout_as_signin'), 0)

...
WebUI.click(findTestObject('Checkout_objects/Page_Checkout/Page_Checkout/Checkout_as_signin'), FailureHandling.STOP_ON_FAILURE)

WebUI.sendKeys(findTestObject('Checkout_objects/Sign_in_checkout/Sign_in_chkout_email'), 'ecptest@netsolutions.com')

WebUI.sendKeys(findTestObject('Checkout_objects/Sign_in_checkout/Sign_in_chkout_pass'), 'Tester123@4')
...
WebUI.verifyTextPresent('You are logged in as', false)

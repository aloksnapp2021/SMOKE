...
WebUI.verifyElementPresent(findTestObject('Checkout_objects/Page_Checkout/Payment_debit_card'), 0)

WebUI.verifyElementPresent(findTestObject('Order_Placement_Journey/HWD_Journey/Checkout_Paypal_radio'), 0)

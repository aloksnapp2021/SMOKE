...
ReviewTotal = WebUI.getText(findTestObject('Order_Placement_Journey/HWD_Journey/Total (inc VAT) (Value)'))

TotalPrice = WebUI.getText(findTestObject('Order_Placement_Journey/HWD_Journey/Checkout Total Price'))

WebUI.verifyEqual(ReviewTotal, TotalPrice)

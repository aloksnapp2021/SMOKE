...
WebUI.sendKeys(findTestObject('Order_Placement_Journey/HWD_Journey/input__email'), 'fgdgfdgh')

WebUI.sendKeys(findTestObject('Order_Placement_Journey/HWD_Journey/input__mobileno'), '45746')

WebUI.delay(2)

WebUI.verifyTextPresent('Please enter a valid Email address.', false)

WebUI.verifyTextPresent('Mobile no. must contain minimum 10 characters.', false)

WebUI.sendKeys(findTestObject('Order_Placement_Journey/HWD_Journey/input__mobileno'), 'fgdggd')
...
WebUI.verifyTextPresent('Please enter valid first name.', false)

WebUI.verifyTextPresent('Please enter valid last name.', false)

WebUI.verifyTextPresent('Please enter valid mobile no.', false)

...
postcode = WebUI.getAttribute(findTestObject('Order_Placement_Journey/HWD_Journey/Postcode_Delivery'), 'value')

WebUI.verifyNotEqual(address1,"")

WebUI.verifyNotEqual(address2, "")

WebUI.verifyNotEqual(town, "")

WebUI.verifyNotEqual(country, "")

WebUI.verifyNotEqual(postcode, "")

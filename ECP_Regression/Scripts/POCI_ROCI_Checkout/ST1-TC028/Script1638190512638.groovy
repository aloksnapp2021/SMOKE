...
switch (GlobalVariable.SOPv3_Instance) {
    ...
    case 'ST4':
		...
		WebUI.click(findTestObject('SOPV3/CNC/select_Order_type'))
		
		WebUI.delay(2)
		
		WebUI.verifyElementAttributeValue(findTestObject('SOPV3/CNC/Select_order_type_POCI'), 'value', 'paid', 0)
		
		WebUI.verifyElementAttributeValue(findTestObject('SOPV3/CNC/select_order_type_Roci'), 'value', 'reserved', 0)

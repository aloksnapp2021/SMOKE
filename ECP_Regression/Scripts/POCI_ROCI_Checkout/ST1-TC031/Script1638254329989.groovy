...
switch (GlobalVariable.SOPv3_Instance) {
    ...
    case 'ST4':
	   ...
	   WebUI.click(findTestObject('SOPV3/CNC/Collection_orders_menu'))
        ...
        WebUI.sendKeys(findTestObject('SOPV3/Order Processing/Search Keyword'), '113-98794879834334')
		
		WebUI.click(findTestObject('SOPV3/Order Processing/Submit'))
		
		WebUI.delay(3)

        WebUI.verifyElementPresent(findTestObject('SOPV3/CNC/No_order_found_object'), 0)

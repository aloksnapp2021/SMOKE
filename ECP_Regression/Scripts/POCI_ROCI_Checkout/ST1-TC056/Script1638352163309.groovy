...
switch (GlobalVariable.SOPv3_Instance) {
    ...
    case 'ST4':
        ...
        WebUI.verifyElementPresent(findTestObject('SOPV3/CNC/Order_detail_Page_Elements/Status(New)'), 0, FailureHandling.OPTIONAL)
        ...
        WebUI.verifyElementPresent(findTestObject('SOPV3/CNC/Order_detail_Page_Elements/Status(day ago)'), 0, FailureHandling.OPTIONAL)

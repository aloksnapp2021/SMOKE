...
WebUI.callTestCase(findTestCase('Order_Process/CNC - POCI_ROCI/ROCI_ST1'), [:], FailureHandling.STOP_ON_FAILURE)
...
switch (GlobalVariable.SOPv3_Instance) {
	...
	case 'ST4':
		...
		color1=WebUI.verifyElementPresent(findTestObject('SOPV3/CNC/Order_detail_Page_Elements/New Status(Color-black)'), 0, FailureHandling.OPTIONAL)
		println(color1)
	  ...
	  color2= WebUI.verifyElementPresent(findTestObject('SOPV3/CNC/Order_detail_Page_Elements/Days_ago(color-red)'), 0, FailureHandling.OPTIONAL)
	  println(color2)

...
switch (GlobalVariable.SOPv3_Instance) {
    ...
    case 'ST4':
        ...
        WebUI.click(findTestObject('SOPV3/CNC/Order_detail_Page_Elements/Order_Date_time_column_heading'))

        WebUI.delay(2)

        WebUI.click(findTestObject('SOPV3/CNC/Order_detail_Page_Elements/Order_Date_time_column_heading'))

        WebUI.verifyElementPresent(findTestObject('SOPV3/CNC/Order_detail_Page_Elements/Order_Date_time_heading_dropdown_icon'), 

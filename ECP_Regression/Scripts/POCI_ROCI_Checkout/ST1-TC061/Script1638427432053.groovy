...
switch (GlobalVariable.SOPv3_Instance) {
    ...
    case 'ST4':
		...
		WebUI.click(findTestObject('SOPV3/CNC/Order_detail_Page_Elements/Action_button'))
		
		WebUI.waitForPageLoad(0)
		
		WebUI.delay(2)
		
		WebUI.verifyElementPresent(findTestObject('SOPV3/Order Processing/Order_detail/Summary tab'), 0)

...
WebUI.scrollToElement(findTestObject('Checkout_objects/Page_Checkout/Page_Checkout/Pay_By_Paypal_object'), 0)

WebUI.click(findTestObject('Checkout_objects/Page_Checkout/Page_Checkout/Pay_By_Paypal_object'))

WebUI.delay(3)

WebUI.verifyElementPresent(findTestObject('Order_Placement_Journey/HWD_Journey/Pay With paypal Button'), 0)

...
WebUI.selectOptionByValue(findTestObject('SOPV3/Login/login_select_site_name'), '1', false)

WebUI.click(findTestObject('SOPV3/Login/Login_Submit'))

WebUI.verifyElementPresent(findTestObject('SOPV3/Order Processing/Paypal Credit Braintree Option'), 0)

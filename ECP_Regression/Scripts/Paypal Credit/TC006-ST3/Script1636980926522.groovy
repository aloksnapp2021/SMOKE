...
WebUI.scrollToElement(findTestObject('Order_Placement_Journey/HWD_Journey/Pay With paypal Button'), 0)

Amount = WebUI.getText(findTestObject('Order_Placement_Journey/HWD_Journey/Checkout Total Price'))
...
WebUI.scrollToElement(findTestObject('SOPV3/Order Processing/Search Keyword'), 0)

WebUI.sendKeys(findTestObject(null), Keys.chord(Keys.UP))
...
WebUI.click(findTestObject('SOPV3/Order Processing/Order_detail/Checkbox product return (ST3)'))
...
WebUI.scrollToElement(findTestObject('SOPV3/Order Processing/Payment_Processing/button_Move To'), 0)

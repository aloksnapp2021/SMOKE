...
WebUI.verifyElementPresent(findTestObject('Product_Listing_Object/In Stock Text'), 0)

WebUI.verifyElementPresent(findTestObject('Product_Details_Objects/PDP/Next_day_delivery_time_box'), 0)

...
WebUI.click(findTestObject('Product_Details_Objects/PDP/Add_to_basket'))
...
WebUI.verifyElementPresent(findTestObject('Product_Details_Objects/button_Collection'), 0)

WebUI.verifyElementPresent(findTestObject('Product_Details_Objects/button_UK Delivery'), 0)

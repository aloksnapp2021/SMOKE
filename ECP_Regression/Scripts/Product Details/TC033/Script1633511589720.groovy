...
WebUI.sendKeys(findTestObject('Product_Details_Objects/input_search_box'), GlobalVariable.ProductNo8)
...
WebUI.verifyElementPresent(findTestObject('Product_Details_Objects/PDP/Total price'), 0)

WebUI.verifyElementPresent(findTestObject('Product_Details_Objects/PDP/Save'), 0)

WebUI.verifyElementPresent(findTestObject('Product_Details_Objects/PDP/Price (Original)'), 0)

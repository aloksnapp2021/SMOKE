...
WebUI.verifyElementPresent(findTestObject('Product_Details_Objects/PDP/Quantity_2'), 0)

WebUI.verifyElementNotPresent(findTestObject('Product_Details_Objects/PDP/Quantity_21'), 0)

WebUI.click(findTestObject('Product_Details_Objects/PDP/Quantity_2'))

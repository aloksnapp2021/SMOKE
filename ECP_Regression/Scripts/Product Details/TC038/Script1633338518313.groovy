...
WebUI.sendKeys(findTestObject('Product_Details_Objects/PDP_CNC/CNC_popup_input_postcode'), GlobalVariable.Postcode2)
...
WebUI.verifyElementPresent(findTestObject('Product_Details_Objects/PDP_CNC/CNC_page_in_stock_products'), 0, FailureHandling.STOP_ON_FAILURE)

WebUI.verifyTextPresent('Collect Today', false, FailureHandling.CONTINUE_ON_FAILURE)

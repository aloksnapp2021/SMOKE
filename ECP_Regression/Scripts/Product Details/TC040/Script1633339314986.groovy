...
WebUI.click(findTestObject('Product_Details_Objects/PDP_CNC/CNC_page_qty_box'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('Product_Details_Objects/PDP/Quantity_20'), FailureHandling.CONTINUE_ON_FAILURE)

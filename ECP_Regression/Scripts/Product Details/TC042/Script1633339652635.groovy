...
WebUI.sendKeys(findTestObject('Product_Details_Objects/PDP_CNC/CNC_popup_input_postcode'), GlobalVariable.Postcode)
...
WebUI.verifyElementPresent(findTestObject('Product_Details_Objects/PDP_CNC/CNC_continue_shopping_button'), 0, FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('Product_Details_Objects/PDP_CNC/CNC_add_to_home_delivery_button'), 0, FailureHandling.STOP_ON_FAILURE)

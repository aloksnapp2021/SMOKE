...
WebUI.click(findTestObject('Product_Details_Objects/PDP/Specifications'))

WebUI.delay(2)

WebUI.verifyTextPresent('Length', false)

WebUI.verifyTextPresent('Width', false)

WebUI.verifyTextPresent('Height', false)

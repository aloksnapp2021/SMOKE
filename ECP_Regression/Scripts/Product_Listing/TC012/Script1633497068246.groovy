...
WebUI.verifyElementNotPresent(findTestObject('Product_Listing_Object/PLP_REG_validation_message'), 2)

WebUI.delay(2)

WebUI.verifyTextPresent('Battery', false, FailureHandling.STOP_ON_FAILURE)

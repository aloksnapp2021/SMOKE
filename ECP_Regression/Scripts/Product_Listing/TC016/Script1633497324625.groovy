...
WebUI.click(findTestObject('Basket_objects/Cart_postcode_objects/button_UK Delv_after_post_code'), FailureHandling.OPTIONAL)

WebUI.delay(5)

WebUI.scrollToElement(findTestObject('Product_Listing_Object/Page_Checkout/Checkout_Express_Delivery'), 5)

WebUI.verifyElementPresent(findTestObject('Product_Listing_Object/Page_Checkout/Checkout_Express_Delivery'), 5)

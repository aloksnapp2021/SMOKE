...
WebUI.verifyElementPresent(findTestObject('Product_Listing_Object/Auto Promo Applied'), 0)

WebUI.verifyTextPresent('PROMOCODE APPLIED', false, FailureHandling.OPTIONAL)
...
'(If fail) Change auto promo applicable category at step 2'
WebUI.verifyElementPresent(findTestObject('Product_Listing_Object/Auto Promo Applied'), 0)
...
PromoCode = WebUI.getAttribute(findTestObject('Basket_objects/Random_object/input_Promo_code'), 'value')

WebUI.click(findTestObject('Basket_objects/Random_object/Promo_code_Remove_button'))

WebUI.delay(3)

WebUI.verifyTextPresent('USE CODE:', false, FailureHandling.OPTIONAL)

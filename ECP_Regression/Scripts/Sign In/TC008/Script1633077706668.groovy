...
WebUI.sendKeys(findTestObject('Login_object/input__password'), 'Tester')

WebUI.click(findTestObject('Login_object/button_Sign In'))

WebUI.delay(2)

WebUI.scrollToElement(findTestObject('Login_object/input__email'), 3)

WebUI.verifyElementPresent(findTestObject('Login_object/wrongpassword_error'), 5)

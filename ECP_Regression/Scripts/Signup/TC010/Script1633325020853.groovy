...
WebUI.verifyElementAttributeValue(findTestObject('Signup_objects/input_Password'), 'type', 'password', 0)
...
WebUI.verifyElementPresent(findTestObject('Signup_objects/Confirm_password_validation_message'), 5)

...
WebUI.sendKeys(findTestObject('Signup_objects/input_Confirm_password'), 'Tester@123123')
...
WebUI.verifyTextPresent('The passwords entered do not match. Please try again.', true)

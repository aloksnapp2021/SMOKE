...
WebUI.sendKeys(findTestObject('Homepage_objects/Home_only/input_reg'), 'LR53ETT')

WebUI.click(findTestObject('HeaderS_objects/Search_home/input_Reg_submit'))

WebUI.verifyElementPresent(findTestObject('Homepage_objects/Home_only/input_searchbar'), 5)
...
//Validating FIFM icon showing for Masked Brand Product
WebUI.verifyElementPresent(findTestObject('Product_Details_Objects/PDP/Fit It For Me Icon'), 5)
...
//Adding required paired product for oil
...
WebUI.click(findTestObject('Basket_objects/FIFM/button_View details'))

WebUI.click(findTestObject('Basket_objects/FIFM/Select Work Shop button'))

WebUI.click(findTestObject('Basket_objects/FIFM/button_Continue'))

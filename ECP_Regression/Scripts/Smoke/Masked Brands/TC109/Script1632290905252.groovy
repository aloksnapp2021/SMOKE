...
//Changes Reg at FIFM journey so that user can see compatibal products list at review page
WebUI.setText(findTestObject('Order_Placement_Journey/FIFM_Journey/input_FIFM_REG'), 'LR53ETT')

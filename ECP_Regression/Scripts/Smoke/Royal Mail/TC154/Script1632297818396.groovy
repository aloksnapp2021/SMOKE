...
WebUI.sendKeys(findTestObject('HeaderS_objects/Search_home/input_search_box'), Keys.chord(Keys.ENTER))
...
WebUI.verifyElementPresent(findTestObject('Order_Placement_Journey/HWD_Journey/button_Place Order'), 0, FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('Checkout_objects/Page_Checkout/Royal Mail'), 0)

WebUI.verifyElementNotPresent(findTestObject('Checkout_objects/Page_Checkout/International Delivery'), 0)

...
WebUI.waitForElementVisible(findTestObject('Login_object/span_My Account'), 0, FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('Login_object/span_My Account'), 5)

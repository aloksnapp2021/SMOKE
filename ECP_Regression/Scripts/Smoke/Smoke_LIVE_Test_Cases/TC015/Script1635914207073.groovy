...
WebUI.waitForElementVisible(findTestObject('Login_object/input__email'), 0)

WebUI.click(findTestObject('Login_object/input__email'))
...
WebUI.scrollToElement(findTestObject('Login_object/wrongpassword_error'), 3)

WebUI.verifyElementPresent(findTestObject('Login_object/wrongpassword_error'), 1)

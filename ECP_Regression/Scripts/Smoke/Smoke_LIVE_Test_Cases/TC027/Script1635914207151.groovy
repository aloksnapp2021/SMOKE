...
WebUI.scrollToElement(findTestObject('Order_Placement_Journey/FIFM_Journey/button_Select workshop'), 2)
...
WebUI.click(findTestObject('Order_Placement_Journey/FIFM_Checkout/select_Country_dropdown'))

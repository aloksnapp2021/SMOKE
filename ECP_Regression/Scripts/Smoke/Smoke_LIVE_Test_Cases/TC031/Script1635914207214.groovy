...
WebUI.verifyElementPresent(findTestObject('Basket_objects/Random_object/cart_product_price'), 5)

WebUI.verifyElementPresent(findTestObject('Basket_objects/Random_object/subtotal_price'), 5)

WebUI.verifyElementPresent(findTestObject('Basket_objects/Random_object/total_price'), 5)

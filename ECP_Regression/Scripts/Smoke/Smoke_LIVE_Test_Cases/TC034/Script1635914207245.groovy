...
println('Total_parsed_price: ' + Total_parsed_price)
...
println('pricevalue_final_parsed: ' + pricevalue_final_parsed)

WebUI.verifyGreaterThanOrEqual(Total_parsed_price / 2, pricevalue_final_parsed)

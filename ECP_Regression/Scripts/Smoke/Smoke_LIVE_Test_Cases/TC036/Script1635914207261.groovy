...
WebUI.sendKeys(findTestObject('Basket_objects/Random_object/input_Discount code'), 'DUMMYPROMO')

WebUI.click(findTestObject('Basket_objects/Random_object/Promo_code_submit'))

WebUI.delay(2)

WebUI.verifyTextPresent('The promotion entered is invalid or has expired', false)

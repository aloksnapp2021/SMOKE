...
WebUI.callTestCase(findTestCase('Smoke/Smoke_LIVE_Test_Cases/TC016'), [:], FailureHandling.STOP_ON_FAILURE)


//Steps disabled as the control has been moved to Third party which we can't automate.
//WebUI.delay(4)
//

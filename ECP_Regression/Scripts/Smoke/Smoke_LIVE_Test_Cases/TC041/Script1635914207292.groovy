...
WebUI.click(findTestObject('Homepage_objects/Newsletter/Checkbox_1'))

WebUI.click(findTestObject('Homepage_objects/Newsletter/Checkbox_2'))

WebUI.click(findTestObject('Homepage_objects/Newsletter/Submit_button_LIVE'))

WebUI.delay(5)

WebUI.verifyElementPresent(findTestObject('Homepage_objects/Newsletter/Newsletter_success_popup_message'), 10)

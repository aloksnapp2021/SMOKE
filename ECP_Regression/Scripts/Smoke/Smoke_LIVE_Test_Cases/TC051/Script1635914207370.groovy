...
'This is the END key in the keyboard.'
WebUI.sendKeys(findTestObject(null), Keys.chord(Keys.END))

WebUI.verifyTextPresent('How to Shop', false)

WebUI.verifyTextPresent('Customer Services', false)

WebUI.verifyTextPresent('Help & Advice', false)

WebUI.verifyTextPresent('About Us', false)

WebUI.verifyTextPresent('Choose Your Country', false)

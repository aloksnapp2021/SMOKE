...
WebUI.click(findTestObject('Homepage_objects/Tier_4_links/Suspension_Steering/a_Suspension Arms  Joints'))

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.verifyTextPresent('Suspension Arms & Joints', false)

...
WebUI.click(findTestObject('Homepage_objects/Tier_4_links/Car_maintenance/a_Paints'))
...
WebUI.verifyElementPresent(findTestObject('Product_Details_Objects/Dangerous Goods/Dangerous Goods'), 5, FailureHandling.OPTIONAL)

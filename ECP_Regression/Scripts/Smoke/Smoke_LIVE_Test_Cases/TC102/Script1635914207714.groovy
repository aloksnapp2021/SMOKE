...
WebUI.mouseOver(findTestObject('Homepage_objects/Home_only/a_Batteries'))
...
WebUI.verifyElementPresent(findTestObject('Product_Listing_Object/Check Stock/Choose a Store to collect from Text'), 10)

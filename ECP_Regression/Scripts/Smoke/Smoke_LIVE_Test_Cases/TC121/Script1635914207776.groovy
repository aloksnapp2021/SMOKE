...
WebUI.verifyElementPresent(findTestObject('Product_Listing_Object/Out of stock Text'), 10)

WebUI.verifyElementPresent(findTestObject('Product_Listing_Object/Email When In Stock Button'), 10)

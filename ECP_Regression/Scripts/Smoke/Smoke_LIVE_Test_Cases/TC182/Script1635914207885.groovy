...
WebUI.verifyElementPresent(findTestObject('Order_Placement_Journey/Checkout_CC/input_Credit Card Number'), 5)

WebUI.verifyElementPresent(findTestObject('Order_Placement_Journey/Checkout_CC/input_ExpDate'), 5)

WebUI.verifyElementPresent(findTestObject('Order_Placement_Journey/Checkout_CC/input_CVV'), 5)

...
WebUI.delay(1)
		...
		WebUI.click(findTestObject('CMS/Promocode/link_add_single_promocode'), FailureHandling.STOP_ON_FAILURE)

		WebUI.verifyTextPresent('Add New Single Promo Code', false)

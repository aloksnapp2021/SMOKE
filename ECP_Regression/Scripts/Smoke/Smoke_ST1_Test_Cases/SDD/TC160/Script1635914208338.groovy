...
WebUI.sendKeys(findTestObject('Basket_objects/Cart_postcode_objects/input_postcode'), GlobalVariable.Postcode4)
...
WebUI.verifyElementPresent(findTestObject('Checkout_objects/Page_Checkout/SDD'), 0)

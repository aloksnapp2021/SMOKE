...
WebUI.waitForElementPresent(findTestObject('Login_object/input__email'), 5, FailureHandling.OPTIONAL)
...
WebUI.waitForElementPresent(findTestObject('Login_object/span_My Account'), 5, FailureHandling.OPTIONAL)

WebUI.verifyElementPresent(findTestObject('Login_object/span_My Account'), 1)

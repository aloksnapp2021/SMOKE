...
WebUI.waitForElementPresent(findTestObject('Basket_objects/PLP_cart_minicart/a_Add to Basket'), 0)

WebUI.click(findTestObject('Basket_objects/PLP_cart_minicart/a_Add to Basket'))

WebUI.waitForElementPresent(findTestObject('Basket_objects/PLP_cart_minicart/cart_popup_View Basket'), 0)

WebUI.click(findTestObject('Basket_objects/PLP_cart_minicart/cart_popup_View Basket'))

WebUI.waitForElementPresent(findTestObject('Basket_objects/Random_object/Promo_code_Remove_button'), 5, FailureHandling.OPTIONAL)

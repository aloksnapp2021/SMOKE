...
WebUI.sendKeys(findTestObject('Forgot_objects/input__email'), GlobalVariable.Forgot_invalid_email)

WebUI.delay(1)

WebUI.click(findTestObject('Forgot_objects/button_Submit'))

WebUI.verifyElementPresent(findTestObject('Forgot_objects/Forgot_non_regstrd_email_error'), 5)

...
WebUI.waitForElementPresent(findTestObject('Homepage_objects/Home_only/a_Travel  Touring'), 0)

WebUI.click(findTestObject('Homepage_objects/Home_only/a_Travel  Touring'))

WebUI.click(findTestObject('Global_objects/Sale_Popup_close_LIVE'), FailureHandling.OPTIONAL)

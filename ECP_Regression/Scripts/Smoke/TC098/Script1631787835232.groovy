...
WebUI.waitForElementPresent(findTestObject('HeaderS_objects/Search_home/input_Reg_submit'), 0)
...
WebUI.verifyElementPresent(findTestObject('Product_Listing_Object/Surcharge/Surcharge'), 5)

...
WebUI.sendKeys(findTestObject('HeaderS_objects/Search_home/input_search_box'), GlobalVariable.ProductNo6)
...
WebUI.click(findTestObject('Basket_objects/FIFM/button_Select workshop'))

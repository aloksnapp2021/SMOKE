...
WebUI.verifyElementNotPresent(findTestObject('Product_Details_Objects/PDP/Quantity_1'), 5)

WebUI.verifyElementPresent(findTestObject('Product_Details_Objects/PDP/Quantity_2'), 5)

WebUI.verifyElementPresent(findTestObject('Product_Details_Objects/PDP/Quantity_4'), 5)

WebUI.verifyElementPresent(findTestObject('Product_Details_Objects/PDP/Quantity_20'), 5)

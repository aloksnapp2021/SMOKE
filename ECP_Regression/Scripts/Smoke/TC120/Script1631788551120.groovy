...
WebUI.verifyElementPresent(findTestObject('Product_Listing_Object/In Stock Text'), 5)

WebUI.verifyElementPresent(findTestObject('Product_Listing_Object/Add to Basket_button'), 5)

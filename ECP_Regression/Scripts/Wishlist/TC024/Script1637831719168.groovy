...
WebUI.click(findTestObject('Wishlist/Few_Items_added_before_signin/Few_items_popup_Yes'))

WebUI.verifyElementPresent(findTestObject('Wishlist/Promocode_auto_wishlist'), 0, FailureHandling.OPTIONAL)
